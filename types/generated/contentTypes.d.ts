...
export interface ApiIndusIndus extends Schema.CollectionType {
  collectionName: 'induses';
  info: {
    singularName: 'indus';
    pluralName: 'induses';
    displayName: 'Indus';
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    excerpt: Attribute.Text;
    coverImage: Attribute.Media<'images' | 'files' | 'videos'>;
    date: Attribute.Date;
    ...
    content: Attribute.DynamicZone<
      ['cta.button', 'body.section', 'marketing.subscribe']
    >;
    meta: Attribute.Component<'seo.meta', true>;
    herocta: Attribute.Component<'cta.button'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProPro extends Schema.CollectionType {
  collectionName: 'pros';
  info: {
    singularName: 'pro';
    pluralName: 'pros';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::pro.pro', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::pro.pro', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::indus.indus': ApiIndusIndus;
      'api::industry.industry': ApiIndustryIndustry;
      'api::job.job': ApiJobJob;
      'api::navbar.navbar': ApiNavbarNavbar;
      'api::post.post': ApiPostPost;
      'api::pricing.pricing': ApiPricingPricing;
      'api::pro.pro': ApiProPro;
